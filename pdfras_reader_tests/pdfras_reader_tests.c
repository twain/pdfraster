...
void page_count_tests()
{
    ...
    ASSERT(7 == pdfrasread_page_count_filename("sample all formats.pdf"));
...
void error_tests()
{
    ...
    // open our standard test file
    errmask = 0;
    pdfrasread_set_global_error_handler(error_test_handler);
