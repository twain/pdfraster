...
typedef enum {
	...
	PDFRAS_READER_PAGE_WIDTH_FAIL = err_base + 12,
	PDFRAS_READER_PAGE_HEIGHT_FAIL = err_base + 13,
	PDFRAS_READER_PAGE_STRIP_COUNT_FAIL = err_base + 14,
	PDFRAS_READER_PAGE_MAX_STRIP_SIZE_FAIL = err_base + 15,
	PDFRAS_READER_PAGE_COMPRESSION_FAIL = err_base + 16,
	MAX_ERROR_CODE = err_base + 17,
} pdfrt_error_code;
